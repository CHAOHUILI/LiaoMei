...
@SuppressLint("NewApi")
public class FooterPageActivity extends BaseActivity implements OnTabChangeListener {
...
//	public static RadioGroup radioGroup;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//	SealAppContext.init(FooterPageActivity.this);
	}
...
//		((RadioButton) radioGroup.getChildAt(0)).toggle();
	...
	private Intent getTabItemIntent(Class classZ){
		Intent intent = new Intent(FooterPageActivity.this, classZ);	
		return intent;
	}
	@Override
