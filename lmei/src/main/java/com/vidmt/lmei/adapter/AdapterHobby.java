...
public class AdapterHobby extends BaseAdapter {
	...
	public AdapterHobby(Context context, List<String> list, ImageLoader imageLoader, DisplayImageOptions options) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = lif.inflate(R.layout.adapter_hobby, null);
		...
		String hobby = list.get(position);

		if (hobby != null) {
			holder.hobbyname.setText(hobby);
		}
		return convertView;
	}
